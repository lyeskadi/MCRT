function pos = haloMC_initialize_plasmacolumn(filename,Npoints,L_RAID,TScase,useOpacity)
doPlot = 0;
...
r = interp1(cdfval_save,invcdfval_save,rand(1,Npoints)); % Use inverse sampling to reproduce radial profile expected from TS data
...
%% Optional: verify that sampling is correct
if doPlot
% Plot points
figure;
plot3(x,y,z,'x');
